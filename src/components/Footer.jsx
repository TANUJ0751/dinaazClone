...
import logo from "../assets/Dinaaz-Hair-Skin-logo-vertical.png.svg"
import { Link } from "react-router-dom"

const Footer = () => {
  return (
    <div>
      <footer className={sty_last.footer}>
        <div className={sty_last.footer_container}>

          {/* LEFT SECTION */}
          <div className={sty_last.footer_left}>
            <div className={sty_last.logo_box}>
              <img
                src={logo}
                alt="Logo"
                height="200px"
            ...
            <p className={sty_last.description}>
              ...
              treatments, we are dedicated to helping you achieve a youthful
              and confident look.
            </p>
          </div>
          <div className={sty_last.footer_right}>

            {/* QUICK LINKS */}
            <div className={sty_last.footer_links}>
              <h4>Quick Links</h4>
              <ul>
                <li>Home</li>
                <li>About</li>
            ...
            <div className={sty_last.footer_links}>
              ...
              <p className={sty_last.footer_links_des} >
                Dinaaz Hair & Skin #1, Sai LCM Tower, 2nd Floor,
                9th Cross Rd, Nagarbhavi 1st Stage,
                Phase 3, Chandra Layout, Bengaluru,
                Karnataka 560040
              </p>
              <p>dinaazhairs@gmail.com</p>

              <div className={sty_last.svg_container}>
        ...
        <div className={sty_last.developer_bar}>
          DESIGN AND DEVELOPED BY PYUSH ANAND
        </div>
      </footer>
    </div>
  )
